...
class Data {
  ...
  static List<StatItemData> statItemsData = [
    ...
    StatItemData(value: 02, subtitle: StringConst.YEARS_OF_EXPERIENCE),
    StatItemData(value: 13, subtitle: StringConst.INCREDIBLE_PROJECTS),
  ...
  static List<ProjectCategoryData> projectCategories = [
    ...
    // ProjectCategoryData(title: StringConst.FlutterDeveloper, number: 2),
  ...
  static List<NimBusCardData> nimbusCardData = [
    ...
    NimBusCardData(
      title: StringConst.FlutterDeveloper,
      subtitle: StringConst.xFlutterDeveloper_DESC,
      leadingIcon: Icons.done,
      trailingIcon: Icons.chevron_right,
  ...
  static List<ProjectsModel> projecrdata = Get.put(Controller()).projectsData;
  static data(){
    for( int i = 0 ; i <=projecrdata.length; i++) {
      allProjects.add( ProjectData(
        title: projecrdata[i].projName,
        category: projecrdata[i].projDec,
        projectCoverUrl: projecrdata[i].proImageUrl,
        width: 0.5,
        mobileHeight: 0.3,
      ),);
    }
  ...
  // static List<ProjectData> allProjects = [
  //   ProjectData(
  //     title: projecrdata[0].projName,
  //     category: projecrdata[0].projDec,
